...
### 2. Prepare a list of common variants 
Prepare a 2-columns file: CHROM and POS (no header). In our case, we created a list of variants from the HRC panel with MAF > 0.05 (`maf0.05sites.txt`):
